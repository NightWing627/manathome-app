...
class OtpVerificationEmail extends StatefulWidget {
  String email;
  String otp;
  OtpVerificationEmail({Key key, this.email, this.otp}) : super(key: key);
...
class _OtpVerificationEmailState extends StateMVC<OtpVerificationEmail>
    ...
    UserController _con;
   _OtpVerificationEmailState() : super(UserController()) {
    _con = controller;
  }
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              RaisedButton(
                onPressed: () {
                  print(widget.otp);
                   if(widget.otp == otpInserted)
                   Navigator.push(context, MaterialPageRoute(builder: (_)=> UpdatePasswordWidget(email: widget.email,)));
                },
                shape: StadiumBorder(),
