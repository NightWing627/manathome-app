...
class S {
  ...
  /// `If you Choose to cancel you can do it with 60 seconds after placing the order`
  ...
  /// `Post 60 seconds you will be charged a 100% cancellation fess `
